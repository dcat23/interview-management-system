...
import { NextSessionCard } from '@app/web/components/supporter/dashboard/next-session-card';
import { AwaitingFeedbackList } from '@app/web/components/supporter/awaiting-feedback-list';
import { ActiveProcessesSummary } from '@app/web/components/supporter/dashboard/active-processes-summary';
...
async function SupporterPage() {
  const [session, { data: sessionPage }, { data: processPage }] =
    await Promise.all([
      auth(),
    ...
    <div className="mx-auto max-w-7xl space-y-10">
      <div>
        ...
        <p className="mt-3 text-lg text-muted-foreground">
          Your interview sessions and process activity at a glance
        </p>
      </div>
